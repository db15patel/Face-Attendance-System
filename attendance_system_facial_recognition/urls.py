...
urlpatterns = [
    ...
    #path('delete_user', recog_views.delete_user, name='delete-user'),
    ...
    path('view_employees',recog_views.view_employee,name="view-employees"),
    path('view_my_profile',recog_views.view_my_profile,name="view-my-profile"),
    path('employee_holiday',recog_views.employee_holiday,name="employee-holiday"),
    path('editprofile',recog_views.editprofile,name='change-profile'),
    path('holiday',recog_views.holiday,name='holiday'),
